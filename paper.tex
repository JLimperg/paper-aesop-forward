...
% TODO: check over/underfull boxes
% TODO: ensure that numbers in evaluation discussion match the final data
% TODO: process Massin's minor feedback points
...
Therefore, hypotheses are matched against slots and inserted into the variable indices only once we have found, for each slot, a hypothesis that may match the slot.
...
These results are explained by the number of times either algorithm matches a premise against a hypothesis.
    ...
    \begin{tikzpicture}[scale=0.75]
      \begin{axis}[
        ...
        \addplot[
          ...
          coordinates {
            (1, 32.192292) (2, 39.246833) (3, 47.596875) (4, 53.228625) (5, 60.162625)
          };
        \addplot[
          color=blue,
          mark=square,
          ...
          coordinates {
            (1, 75.599833) (2, 94.688208) (3, 113.647292) (4, 131.776291) (5, 148.492917) 
          };
        \addplot[
          color=orange,
          mark=o,
          ...
          coordinates {
            (1, 101.828250) (2, 111.354459) (3, 115.116500) (4, 125.602792) (5, 130.459292) 
          };
        \addplot[
          color=blue,
          mark=o,
          ...
          coordinates {
            (1, 235.018833) (2, 319.038292) (3, 421.737083) (4, 522.937000) (5, 604.252875) 
          };
      \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
      \begin{axis}[
        ...
        \addplot[
          ...
          coordinates {
            (1, 12.507986) (2, 17.695611) (3, 22.835264) (4, 27.568305) (5, 32.235500) 
          };
        \addlegendentry{naive}
        \addplot[
          color=blue,
          ...
          coordinates {
            (1, 7.969861) (2, 8.940027) (3, 10.796555) (4, 11.887569) (5, 13.822249) 
          };
        \addlegendentry{incremental}
        \addplot[
          color=orange,
          ...
          coordinates {
            (1, 76.545402) (2, 82.492861) (3, 88.691375) (4, 94.362653) (5, 98.254972) 
          };
        \addplot[
          color=blue,
          mark=o,
          ...
          coordinates {
            (1, 11.640499) (2, 15.205833) (3, 18.346361) (4, 21.828027) (5, 24.862680) 
          };
      \end{axis}
    \end{tikzpicture}
