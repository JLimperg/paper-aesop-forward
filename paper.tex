...
SATCHMO's search procedure can be viewed as a special case of our technique: a given set of implications are used as forward rules and a single non-forward rule performs case analysis on disjunctive hypotheses.
