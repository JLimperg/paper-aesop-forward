...
\begin{figure}
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  \caption{Results of the transitivity benchmark. TODO detailed description}%
  \label{fig:trans}
\end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  \caption{Results of the independence benchmark. TODO detailed description}%
  \label{fig:indep}
\end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \end{tikzpicture}
  \end{center}
  \caption{Results of the depth benchmark. TODO detailed description}%
  \label{fig:erase}
\end{figure}
